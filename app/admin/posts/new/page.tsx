  ...
  return (
    <AdminGuard>
      ...
      <div className="mx-auto max-w-3xl px-4 py-10">
        <h1 className="mb-6 text-2xl font-bold">記事を新規作成</h1>
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <p className="mt-1 text-xs text-slate-500">本文の前に挿入される導入ブロックです。</p>
          </div>
          ...
          <div>
            ...
            {loadingAuthors ? (
              ...
              <p className="text-xs text-red-500">
                著者が登録されていません。先に Supabase の authors テーブルで作成してください。
              </p>
            ) : (
              <select
                className="w-full rounded border px-3 py-2"
